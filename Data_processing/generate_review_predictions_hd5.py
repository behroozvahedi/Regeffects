...
class H5Dataset(Dataset):
    def __init__(self, file_caduceus, file_a2z, models, stats, test_group):
...
def main():
    ...
    for EXTRA in ['none','pred','emb','a2z']:
        ...
        for species in species_set:
            caduceus_embeddings_file = workdir+'embeddings.%s.caduceus.h5'%species
            a2z_embeddings_file = workdir+'embeddings.%s.a2z.h5'%species
