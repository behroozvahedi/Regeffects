...
generate_review_predictions_hd5.py: This script reads embeddings generated by (make.review.embedding.caduceus.py & make.review.embedding.a2z.py) and generates predictions for them using our own trained models. It needs the following embedding data files: 'embeddings.*.caduceus.h5' and 'embeddings.*.a2z.h5'
